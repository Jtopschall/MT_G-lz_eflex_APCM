...
async def activate_red_net_heating():
    ...
    await set_server_node_value(activate_manual_control_Temperatur_Prozesswärme_RZ, True)
    await read_server_node_value(activate_Temperatur_Prozesswärme_RZ)
    await set_server_node_value(activate_Temperatur_Prozesswärme_RZ, True)
    await read_server_node_value(temperatur_prozesswärme_RZ)
    await set_server_node_value(temperatur_prozesswärme_RZ, 50)

    await read_server_node_value(activate_manual_control_Temperatur_Prozesswärme_SZ)
    await set_server_node_value(activate_manual_control_Temperatur_Prozesswärme_SZ, True)
    await read_server_node_value(activate_Temperatur_Prozesswärme_SZ)
    await set_server_node_value(activate_Temperatur_Prozesswärme_SZ, True)
    await read_server_node_value(temperatur_prozesswärme_SZ)
    await set_server_node_value(temperatur_prozesswärme_SZ, 50)
...
asyncio.run(activate_red_net_heating())